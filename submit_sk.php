...
<head>
    ...
    <meta name="description"
        content="Novo zariadené apartmány na slnečnom ostrove Rab. Pozrite si fotografie, rezervujte si pobyt a užite si slnečnú dovolenku.">
    <title>Marijini dvori | Odoslanie formulára</title>
        ...
        <div class="section no-pad-bot">
            <div class="container">
                ...
                <div class="row center">
                     <h2 class="header col s12 light">Email odoslaný. Ďakujeme,
                        <?=$firstName?>! Čoskoro vás budeme kontaktovať.
                    </h2>
                </div>
                <div class="row center">
                    <a href="en.html" title="späť" class="btn-large waves-effect waves-light green">Späť</a>
                </div>
            </div>
        </div>
    ...
    <?php
              ...
              <div class="section no-pad-bot">
                  <div class="container">
                      <h1 class="header center green-text">Marijini dvori</h1>
                      <div class="row center">
                          <h2 class="header col s12 light">Email sa nepodarilo odoslať. Kontaktujte nás <a href="mailto:martinkilic0812@gmail.com">priamo cez email</a>.
                          </h2>
                          <h4 class="header col s12 light">Chyba: <?=$e?></h4>
                          <h4 class="header col s12 light">Chyba pri odosielaní emailu: <?=$mail->ErrorInfo?></h4>
                      </div>
                      <div class="row center">
                          <a href="de.html" title="späť" class="btn-large waves-effect waves-light red">Späť</a>
                      </div>
                  </div>
              </div>
              <div class="parallax"><img src="images/background3-draw.jpg" alt="Rab 3" title="Rab 3"></div>
