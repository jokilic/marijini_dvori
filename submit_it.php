            ...
            <div class="container">
                ...
                <div class="row center">
                    <h2 class="header col s12 light">Posta inviata. Grazie,
                        <?=$firstName?>! Ti contatteremo a breve.
                    </h2>
                </div>
                <div class="row center">
    ...
    <?php
              ...
              <div class="section no-pad-bot">
                  <div class="container">
                      <h1 class="header center green-text">Marijini dvori</h1>
                      <div class="row center">
                          <h2 class="header col s12 light">Impossibile inviare la posta. Contattaci <a href="mailto:martinkilic0812@gmail.com">direttamente via email</a>.
                          </h2>
                          <h4 class="header col s12 light">Catch error: $e</h4>
                          <h4 class="header col s12 light">Mail error: {$mail->ErrorInfo}</h4>
                      </div>
                      <div class="row center">
                          <a href="de.html" title="back" class="btn-large waves-effect waves-light red">Ritornare</a>
                      </div>
                  </div>
              </div>
              <div class="parallax"><img src="images/background3-draw.jpg" alt="Rab 3" title="Rab 3"></div>
