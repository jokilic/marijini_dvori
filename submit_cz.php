...
<head>
    ...
    <meta name="description"
        content="Nově zařízené apartmány na slunečním ostrově Rab. Podívejte se na fotografie, rezervujte svůj pobyt a užijte si svou slunečnou dovolenou.">
    <title>Marijini dvori | Odeslání formuláře</title>
        ...
        <div class="section no-pad-bot">
            <div class="container">
                ...
                <div class="row center">
                    <h2 class="header col s12 light">E-mail odeslán. Děkujeme, <?=$firstName?>! Brzy vás budeme kontaktovat.
                    </h2>
                </div>
                <div class="row center">
                    <a href="en.html" title="zpět" class="btn-large waves-effect waves-light green">Zpět</a>
                </div>
            </div>
        </div>
            ...
            <div class="parallax-container full">
                <div class="section no-pad-bot">
                    <div class="container">
                        <h1 class="header center green-text">Marijini dvori</h1>
                        <div class="row center">
                            <h2 class="header col s12 light">Selhalo odeslání e-mailu. Kontaktujte nás <a href="mailto:martinkilic0812@gmail.com">přímo emailem</a>.
                            </h2>
                            <h4 class="header col s12 light">Chyba při zachycení: $e</h4>
                            <h4 class="header col s12 light">Chyba e-mailu: {$mail->ErrorInfo}</h4>
                        </div>
                        <div class="row center">
                            <a href="de.html" title="zpět" class="btn-large waves-effect waves-light red">Zpět</a>
                        </div>
                    </div>
                </div>
                <div class="parallax"><img src="images/background3-draw.jpg" alt="Rab 3" title="Rab 3"></div>
